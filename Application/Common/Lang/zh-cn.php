...
return array(
	// 站点信息
	'common_site_name'					=>	'艺之维',
	'common_site_vice_name'				=>	'教务管理系统',
	'common_site_title'					=>	'艺之维后台管理系统',

	// 应用信息
	'common_application_name'			=>	'艺之维',
	'common_application_ver'			=>	'v2.3.1',
	'common_application_website'		=>	'http://baidu.com/',
	...
	// 等级
	'common_level_list'				=>	array(
			0 => array('id' => 0, 'name' => 'A', 'checked' => true),
			1 => array('id' => 1, 'name' => 'B'),
			2 => array('id' => 2, 'name' => 'C'),
			3 => array('id' => 3, 'name' => 'D'),
			4 => array('id' => 4, 'name' => 'E'),
	...
	// 类型
	'common_group_list'				=>	array(
		1 => array('id' => 1, 'name' => '预约', 'checked' => true),
		2 => array('id' => 2, 'name' => '无意向'),
		3 => array('id' => 3, 'name' => '到访'),
		4 => array('id' => 4, 'name' => '生成合同'),
	),
	// 是否启用
	...
	'common_regex_jiage'				=>	'^(0|[1-9]\d{1,9})(\.\d{1,2})?$',
	// 分页
