...
-- ----------------------------
BEGIN;
INSERT INTO `sc_admin` VALUES ('1', 'admin', 'e373eced198d742d0b0ca7b6ee6bca26', '986819', '', '0', '287', '1506252004', '1', '1481350313', '2017-09-24 19:20:04', 'admin', '1'), ('4', 'ceshi', '574caaf9805d477ba0c65172edd04b9f', '461595', '', '0', '11', '1506249873', '14', '1505059297', '2017-09-24 18:44:34', '123456', '0'), ('5', 'guwen', '91d78e3cd10b6264f2f7421312a1225e', '975362', '', '0', '10', '1505748590', '15', '1505307004', '2017-09-18 23:29:50', '张三顾问', '4'), ('6', 'guwen1', '064ea87d6d4a17de767ee656509dc912', '689132', '', '0', '2', '1506005602', '15', '1505308747', '2017-09-21 22:53:22', '顾问1', '4'), ('7', 'caiwu', 'f8da8255742955fa46efc9f20142c089', '778626', '', '0', '5', '1505911907', '16', '1505404864', '2017-09-20 20:51:47', '张财务', '4'), ('8', 'caiwu1', '05309c8f2d4c177802dba07729a4790b', '043649', '', '0', '7', '1506005634', '16', '1505616885', '2017-09-21 22:53:54', '财务1', '4'), ('9', 'laoshi', 'df1cf9394876f91fe158701d4a57a686', '187124', '', '0', '5', '1506006260', '17', '1505915155', '2017-09-21 23:04:20', '张老师', '4'), ('10', 'xuexiao', 'c85332ed0fd8eeca3c79e08b9e8acd12', '651740', '17634002322', '0', '1', '1506250020', '14', '1506250003', '2017-09-24 18:47:00', '分校', '1'), ('11', 'fxguweu1', '2bd6f0b76ef16d6b35e923b8bc612edc', '189955', '17744443333', '0', '1', '1506251490', '15', '1506250200', '2017-09-24 19:11:30', 'fxguweu1', '10'), ('12', 'fxcaiwu1', 'd084e477c4c81bdcb36d79ab2a7b8cc3', '232989', '15866665555', '0', '0', '0', '16', '1506251458', '2017-09-24 19:10:58', 'fxcaiwu1', '10'), ('13', 'fenxiao2', 'e08cc5e0084e7a5d791ab030bd485957', '441908', '18877777666', '0', '2', '1506252694', '14', '1506252033', '2017-09-24 19:31:34', 'fenxiao2', '1'), ('14', 'fx2guwen', 'f948f8828493d9d4814f4c9b31ecfdc7', '086258', '15566664553', '0', '0', '0', '15', '1506252089', '2017-09-24 19:21:29', 'fx2guwen', '13'), ('15', 'fx2caiwu', 'bd3e54c9575243e53c34f774492b6865', '036063', '15553332224', '0', '2', '1506252783', '16', '1506252541', '2017-09-24 19:33:03', 'fx2caiwu', '13'), ('16', 'fx2laoshi', '5c9d8aff5e6a602a175d848540f7b847', '332043', '15566665555', '0', '1', '1506252852', '17', '1506252731', '2017-09-24 19:34:12', 'fx2laoshi', '13');
COMMIT;
...
-- ----------------------------
--  Table structure for `sc_caiwu`
-- ----------------------------
DROP TABLE IF EXISTS `sc_caiwu`;
CREATE TABLE `sc_caiwu` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '合同编号',
  `kh_id` int(11) NOT NULL DEFAULT '0' COMMENT '客户id',
  `kh_name` varchar(50) NOT NULL DEFAULT '' COMMENT '客户姓名',
  `yixiang` varchar(50) NOT NULL DEFAULT '' COMMENT '意向',
  `kecheng` varchar(50) NOT NULL DEFAULT '0' COMMENT '课程',
  `createtime` int(11) NOT NULL DEFAULT '0',
  `updatetime` int(11) NOT NULL DEFAULT '0',
  `pay_status` int(1) NOT NULL DEFAULT '1',
  `gw_id` int(5) NOT NULL DEFAULT '1' COMMENT '上级ID',
  `xx_id` int(5) NOT NULL DEFAULT '0' COMMENT '学校id',
  `kc_sc` varchar(50) NOT NULL DEFAULT '' COMMENT '课程时长',
  `kc_jq` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '课程价钱',
  `ht_status` int(11) NOT NULL DEFAULT '0',
  `ht_end` varchar(255) NOT NULL DEFAULT '' COMMENT '合同结束日期',
  `price` decimal(11,2) NOT NULL DEFAULT '0.00' COMMENT '合同金额',
  `yj_price` decimal(11,2) NOT NULL DEFAULT '0.00',
  `sy_price` decimal(11,2) NOT NULL DEFAULT '0.00',
  `cw_id` int(11) NOT NULL DEFAULT '0' COMMENT '财务id',
  `ht_start` varchar(255) NOT NULL DEFAULT '' COMMENT '合同开始日期',
  `beizhu` text,
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_caiwu` VALUES ('57', '9', 'aa', '', '音乐', '1506251565', '1506251565', '0', '11', '10', '22', '222.00', '0', '2017-06-08', '0.00', '0.00', '2221.00', '12', '2013-05-30', ''), ('55', '3', '阿萨德', '', '舞蹈', '1505653241', '0', '0', '5', '4', '22', '222.00', '0', '2013-05-02', '0.00', '0.00', '222.00', '8', '2013-05-02', '333'), ('58', '10', 'aa', '', '舞蹈', '1506252571', '1506252571', '0', '13', '13', '11', '111.00', '0', '2017-12-09', '0.00', '0.00', '11111.00', '15', '2017-08-03', '');
COMMIT;
...
CREATE TABLE `sc_class` (
  ...
  KEY `is_enable` (`is_enable`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='班级类别';

-- ----------------------------
--  Records of `sc_class`
-- ----------------------------
BEGIN;
INSERT INTO `sc_class` VALUES ('7', '0', '一年级', '1', '0', '0', '2016-12-25 14:41:23'), ('10', '0', '二年级', '1', '0', '0', '2016-12-25 14:42:31'), ('16', '10', '三年级', '1', '0', '1482840545', '2016-12-27 20:09:05'), ('25', '0', '九年级', '1', '0', '1491922990', '2017-04-11 23:03:10');
COMMIT;
...
CREATE TABLE `sc_course` (
  ...
  KEY `room_id` (`room_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='教师课程';

-- ----------------------------
--  Records of `sc_course`
-- ----------------------------
BEGIN;
INSERT INTO `sc_course` VALUES ('11', '7', '4', '18', '17', '12', '14', '18', '1', '1484219105', '2017-01-14 18:00:16'), ('12', '7', '1', '17', '19', '12', '14', '17', '1', '1484367651', '2017-01-14 18:34:57'), ('13', '7', '2', '18', '20', '12', '14', '19', '1', '1484367695', '2017-01-14 12:21:35'), ('14', '7', '2', '19', '20', '14', '14', '17', '1', '1484367735', '2017-01-14 12:22:15'), ('15', '7', '1', '17', '19', '14', '17', '18', '1', '1500649170', '2017-07-21 22:59:30');
COMMIT;
...
-- ----------------------------
--  Table structure for `sc_guwen`
-- ----------------------------
DROP TABLE IF EXISTS `sc_guwen`;
CREATE TABLE `sc_guwen` (
  ...
  `createtime` int(11) NOT NULL DEFAULT '0',
  `uptatetime` int(11) NOT NULL,
  `status` int(1) NOT NULL DEFAULT '1',
  `pid` int(5) NOT NULL DEFAULT '1' COMMENT '上级ID',
  PRIMARY KEY (`id`)
...
-- ----------------------------
--  Table structure for `sc_kehu`
-- ----------------------------
DROP TABLE IF EXISTS `sc_kehu`;
CREATE TABLE `sc_kehu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(255) NOT NULL DEFAULT '',
  `age` int(11) NOT NULL DEFAULT '0',
  `sex` varchar(255) NOT NULL DEFAULT '',
  `lxr_1` varchar(255) NOT NULL DEFAULT '',
  `lxrtel_1` varchar(255) NOT NULL DEFAULT '',
  `lxr_2` varchar(255) NOT NULL DEFAULT '',
  `lxrtel_2` varchar(255) NOT NULL DEFAULT '',
  `zx_kc` varchar(255) NOT NULL DEFAULT '',
  `sf_time` int(11) NOT NULL DEFAULT '0',
  `sf_content` text,
  `dianmian` varchar(255) NOT NULL DEFAULT '',
  `gw_name` varchar(255) NOT NULL DEFAULT '',
  `createtime` int(11) NOT NULL DEFAULT '0',
  `laiyuan` varchar(255) NOT NULL DEFAULT '',
  `qudao` varchar(255) NOT NULL DEFAULT '',
  `groupid` int(11) NOT NULL DEFAULT '0',
  `pid` int(11) NOT NULL DEFAULT '0',
  `gw_id` int(11) NOT NULL DEFAULT '0',
  `birthday` varchar(45) NOT NULL,
  `xx_id` int(11) NOT NULL DEFAULT '0' COMMENT '学校id',
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_kehu` VALUES ('1', 'aa', '23', '1', 'aa', '1333222222', '', '', '舞蹈', '0', null, '', '', '1483932878', '', '', '3', '5', '0', '2013-05-02', '4'), ('2', '2222', '23', '2', '22', '22', '22', '22', '2', '0', null, '', '', '1483932878', '', '', '1', '4', '0', '2013-05-02', '4'), ('3', '阿萨德', '0', '', '请问', '15566664444', '', '', '音乐', '0', null, '', '', '1505312046', '', '', '1', '5', '0', '2013-05-02', '4'), ('5', '阿萨德', '0', '', '请问', '15566664444', '', '', '音乐', '0', null, '', '', '1505399715', '', '', '3', '5', '0', '2013-05-02', '4'), ('6', '旺旺', '0', '', '张天琪', '12233334444', '', '', '美术', '0', null, '', '', '1505747439', '', '', '1', '5', '5', '2013-05-02', '4'), ('7', '尔尔', '0', '', '尔尔爸爸', '16655444333', '', '', '舞蹈', '0', null, '', '', '1505747546', '', '', '1', '5', '5', '2016-11-10', '4'), ('8', '鹏鹏', '0', '0', '妈妈/alina', '15544443333', '', '', '音乐', '0', null, '', '', '1506250265', '', '', '1', '10', '11', '2000-11-16', '10'), ('9', 'aa', '0', '0', 'ww', '133222221111', '', '', '音乐', '0', null, '', '', '1506250390', '', '', '2', '11', '11', '2003-05-08', '10'), ('10', 'aa', '0', '0', '妈妈/alina', '15544443333', '', '', '舞蹈', '0', null, '', '', '1506252330', '', '', '2', '13', '14', '2012-05-11', '13');
COMMIT;

-- ----------------------------
--  Table structure for `sc_kehu_copy2`
-- ----------------------------
DROP TABLE IF EXISTS `sc_kehu_copy2`;
CREATE TABLE `sc_kehu_copy2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(255) NOT NULL DEFAULT '',
  `age` int(11) NOT NULL DEFAULT '0',
  `sex` varchar(255) NOT NULL DEFAULT '',
...
-- ----------------------------
--  Records of `sc_kehu_copy2`
-- ----------------------------
BEGIN;
INSERT INTO `sc_kehu_copy2` VALUES ('1', 'aa', '23', '1', 'aa', '1333222222', '', '', '舞蹈', '0', null, '', '', '1483932878', '', '', '3', '5', '0', '1483891200', '4'), ('2', '2222', '23', '2', '22', '22', '22', '22', '2', '0', null, '', '', '1483932878', '', '', '1', '4', '0', '1483932878', '4'), ('3', '阿萨德', '0', '', '请问', '15566664444', '', '', '音乐', '0', null, '', '', '1505312046', '', '', '1', '5', '0', '', '4'), ('5', '阿萨德', '0', '', '请问', '15566664444', '', '', '音乐', '0', null, '', '', '1505399715', '', '', '3', '5', '0', '-28800', '4'), ('6', '旺旺', '0', '', '张天琪', '12233334444', '', '', '美术', '0', null, '', '', '1505747439', '', '', '1', '5', '5', '2013-05-02', '4'), ('7', '尔尔', '0', '', '尔尔爸爸', '16655444333', '', '', '舞蹈', '0', null, '', '', '1505747546', '', '', '1', '5', '5', '2016-11-10', '4');
COMMIT;
...
CREATE TABLE `sc_power` (
  ...
  `add_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=167 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='权限';

-- ----------------------------
--  Records of `sc_power`
-- ----------------------------
BEGIN;
INSERT INTO `sc_power` VALUES ('1', '0', '权限控制', 'Power', 'Index', '5', '1', 'am-icon-recycle', '1481612301'), ('4', '1', '角色管理', 'Power', 'Role', '11', '1', '', '1481639037'), ('8', '0', '类别管理', 'Routine', 'Index', '20', '1', 'am-icon-yelp', '1481697671'), ('10', '8', '班级分类', 'Class', 'Index', '20', '0', '', '1481727987'), ('11', '8', '科目分类', 'Subject', 'Index', '30', '1', '', '1481728003'), ('12', '8', '学期分类', 'Semester', 'Index', '0', '0', '', '1481728021'), ('13', '1', '权限分配', 'Power', 'Index', '21', '1', '', '1482156143'), ('15', '1', '权限添加/编辑', 'Power', 'PowerSave', '22', '0', '', '1482243750'), ('16', '1', '权限删除', 'Power', 'PowerDelete', '23', '0', '', '1482243797'), ('17', '1', '角色组添加/编辑页面', 'Power', 'RoleSaveInfo', '12', '0', '', '1482243855'), ('18', '1', '角色组添加/编辑', 'Power', 'RoleSave', '13', '0', '', '1482243888'), ('19', '1', '管理员添加/编辑页面', 'Admin', 'SaveInfo', '2', '0', '', '1482244637'), ('20', '1', '管理员添加/编辑', 'Admin', 'Save', '3', '0', '', '1482244666'), ('21', '1', '管理员删除', 'Admin', 'Delete', '4', '0', '', '1482244688'), ('22', '1', '管理员列表', 'Admin', 'Index', '1', '1', '', '1482568868'), ('23', '1', '角色删除', 'Power', 'RoleDelete', '14', '0', '', '1482569155'), ('24', '8', '成绩分类', 'Score', 'Index', '40', '0', '', '1482638641'), ('25', '8', '周分类', 'Week', 'Index', '50', '0', '', '1482638899'), ('26', '8', '时段分类', 'Interval', 'Index', '60', '0', '', '1482638982'), ('27', '8', '地区管理', 'Region', 'Index', '70', '0', '', '1482639024'), ('28', '0', '学生管理', 'Xuesheng', 'Index', '1', '1', 'am-icon-mortar-board fs-12', '1482854151'), ('29', '28', '学生列表', 'Xuesheng', 'Index', '1', '1', '', '1482854186'), ('32', '28', '学生添加/编辑页面', 'Xuesheng', 'SaveInfo', '2', '0', '', '1482915262'), ('33', '28', '学生添加/编辑', 'Xuesheng', 'Save', '3', '0', '', '1482915761'), ('34', '28', '学生删除', 'Xuesheng', 'Delete', '4', '0', '', '1482915804'), ('41', '0', '后台配置', 'Config', 'Index', '0', '1', 'am-icon-gear', '1483362358'), ('42', '41', '配置保存', 'Config', 'Save', '1', '0', '', '1483432335'), ('43', '8', '学期添加/编辑', 'Semester', 'Save', '1', '0', '', '1483456550'), ('44', '8', '班级添加/编辑', 'Class', 'Save', '21', '0', '', '1483456605'), ('45', '8', '科目添加/编辑', 'Subject', 'Save', '31', '0', '', '1483456640'), ('46', '8', '成绩添加/编辑', 'Score', 'Save', '41', '0', '', '1483456687'), ('47', '8', '周添加/编辑', 'Week', 'Save', '51', '0', '', '1483456721'), ('48', '8', '时段添加/编辑', 'Interval', 'Save', '61', '0', '', '1483456748'), ('49', '8', '地区添加/编辑', 'Region', 'Save', '71', '0', '', '1483456778'), ('50', '8', '学期删除', 'Semester', 'Delete', '2', '0', '', '1483457140'), ('51', '8', '班级删除', 'Class', 'Delete', '22', '0', '', '1483457222'), ('52', '8', '科目删除', 'Subject', 'Delete', '32', '0', '', '1483457265'), ('53', '8', '成绩删除', 'Score', 'Delete', '42', '0', '', '1483457291'), ('54', '8', '周删除', 'Week', 'Delete', '52', '0', '', '1483457365'), ('55', '8', '时段删除', 'Interval', 'Delete', '62', '0', '', '1483457405'), ('56', '8', '地区删除', 'Region', 'Delete', '72', '0', '', '1483457442'), ('63', '28', 'Excel导出', 'Xuesheng', 'ExcelExport', '5', '0', '', '1484058295'), ('68', '8', '教室管理', 'Room', 'Index', '80', '0', '', '1484304475'), ('69', '8', '教室添加/编辑', 'Room', 'Save', '81', '0', '', '1484304519'), ('70', '8', '教室删除', 'Room', 'Delete', '82', '0', '', '1484304545'), ('71', '8', '文章分类', 'ArticleClass', 'Index', '90', '0', '', '1484580289'), ('72', '8', '文章分类编辑/添加', 'ArticleClass', 'Save', '91', '0', '', '1484580380'), ('73', '8', '文章分类删除', 'ArticleClass', 'Delete', '92', '0', '', '1484580436'), ('74', '0', '文章管理', 'Article', 'Index', '5', '0', 'am-icon-folder-open', '1484581913'), ('75', '74', '文章管理', 'Article', 'Index', '0', '1', '', '1484581938'), ('76', '74', '文章添加/编辑页面', 'Article', 'SaveInfo', '1', '0', '', '1484740785'), ('77', '74', '文章添加/编辑', 'Article', 'Save', '2', '0', '', '1484740810'), ('78', '74', '文章删除', 'Article', 'Delete', '3', '0', '', '1484740826'), ('79', '74', 'Excel导出', 'Article', 'ExcelExport', '6', '0', '', '1484981822'), ('80', '74', '文章状态更新', 'Article', 'StateUpdate', '7', '0', '', '1484982416'), ('81', '0', '站点配置', 'Site', 'Index', '9', '1', 'am-icon-cogs', '1486182943'), ('82', '102', '中间导航', 'NavHeader', 'Index', '0', '1', '', '1486183114'), ('83', '102', '底部导航', 'NavFooter', 'Index', '11', '1', '', '1486183145'), ('84', '102', '导航添加/编辑页面', 'NavHeader', 'SaveInfo', '1', '0', '', '1486183347'), ('85', '102', '导航添加/编辑', 'NavHeader', 'Save', '2', '0', '', '1486183367'), ('86', '102', '导航删除', 'NavHeader', 'Delete', '3', '0', '', '1486183410'), ('87', '102', '导航状态更新', 'NavHeader', 'StateUpdate', '4', '0', '', '1486183462'), ('88', '102', '导航添加/编辑页面', 'NavFooter', 'SaveInfo', '12', '0', '', '1486183538'), ('89', '102', '导航添加/编辑', 'NavFooter', 'Save', '13', '0', '', '1486183800'), ('90', '102', '导航删除', 'NavFooter', 'Delete', '14', '0', '', '1486192992'), ('91', '102', '导航状态更新', 'NavFooter', 'StateUpdate', '15', '0', '', '1486193042'), ('92', '102', '自定义页面', 'CustomView', 'Index', '21', '1', '', '1486193400'), ('93', '102', '自定义页面添加/编辑页面', 'CustomView', 'SaveInfo', '22', '0', '', '1486193449'), ('94', '102', '自定义页面添加/编辑', 'CustomView', 'Save', '23', '0', '', '1486193473'), ('95', '102', '自定义页面删除', 'CustomView', 'Delete', '24', '0', '', '1486193516'), ('96', '102', '自定义页面状态更新', 'CustomView', 'StateUpdate', '25', '0', '', '1486193582'), ('97', '102', '友情链接', 'Link', 'Index', '31', '1', '', '1486194358'), ('98', '102', '友情链接添加/编辑页面', 'Link', 'SaveInfo', '32', '0', '', '1486194392'), ('99', '102', '友情链接添加/编辑', 'Link', 'Save', '33', '0', '', '1486194413'), ('100', '102', '友情链接删除', 'Link', 'Delete', '34', '0', '', '1486194435'), ('101', '102', '友情链接状态更新', 'Link', 'StateUpdate', '35', '0', '', '1486194479'), ('102', '0', '网站管理', 'NavHeader', 'Index', '10', '0', 'am-icon-university fs-12', '1486561030'), ('103', '81', '站点设置', 'Site', 'Index', '0', '1', '', '1486561470'), ('104', '81', '短信设置', 'Sms', 'Index', '3', '1', '', '1486561615'), ('105', '81', '站点设置添加/编辑', 'Site', 'Save', '1', '0', '', '1486561780'), ('106', '81', 'SEO设置', 'Seo', 'Index', '51', '1', '', '1486561958'), ('107', '81', '短信设置添加/编辑', 'Sms', 'Save', '4', '0', '', '1486562011'), ('108', '81', 'SEO设置添加/编辑', 'Seo', 'Save', '52', '0', '', '1486562038'), ('109', '102', '页面设置', 'View', 'Index', '41', '1', '', '1486562396'), ('110', '102', '获取模块数据/保存', 'View', 'GetLayoutModuleData', '42', '0', '', '1486562436'), ('111', '102', '布局添加/编辑', 'View', 'LayoutSave', '43', '0', '', '1486562480'), ('112', '102', '模块添加', 'View', 'ModuleAdd', '47', '0', '', '1487341698'), ('113', '102', '模块保存', 'View', 'ModuleSave', '48', '0', '', '1487341728'), ('114', '102', '布局状态更新', 'View', 'StateUpdate', '44', '0', '', '1487563663'), ('115', '102', '布局删除', 'View', 'LayoutDelete', '45', '0', '', '1487569443'), ('116', '102', '模块删除', 'View', 'ModuleDelete', '49', '0', '', '1487569470'), ('117', '102', '布局排序保存', 'View', 'LayoutSortSave', '46', '0', '', '1487578045'), ('118', '0', '工具', 'Tool', 'Index', '30', '1', 'am-icon-coffee', '1488108044'), ('119', '118', '缓存管理', 'Cache', 'Index', '1', '1', '', '1488108107'), ('120', '118', '站点缓存更新', 'Cache', 'SiteUpdate', '2', '0', '', '1488108235'), ('121', '118', '模板缓存更新', 'Cache', 'TemplateUpdate', '2', '0', '', '1488108390'), ('122', '118', '模块缓存更新', 'Cache', 'ModuleUpdate', '3', '0', '', '1488108436'), ('123', '81', '邮箱设置', 'Email', 'Index', '5', '1', '', '1488531116'), ('124', '81', '邮箱添加/编辑', 'Email', 'Save', '6', '0', '', '1489056600'), ('125', '81', '邮件发送测试', 'Email', 'EmailTest', '7', '0', '', '1489131159'), ('126', '0', '用户管理', 'User', 'Index', '11', '0', 'am-icon-user', '1490794162'), ('127', '126', '用户列表', 'User', 'Index', '0', '1', '', '1490794316'), ('128', '126', '用户编辑/添加页面', 'User', 'SaveInfo', '1', '0', '', '1490794458'), ('129', '126', '用户添加/编辑', 'User', 'Save', '2', '0', '', '1490794510'), ('130', '126', '用户删除', 'User', 'Delete', '3', '0', '', '1490794585'), ('131', '28', 'Excel导入', 'Xuesheng', 'ExcelImport', '6', '0', '', '1491468767'), ('133', '0', '冒泡管理', 'Bubble', 'Index', '12', '0', 'am-icon-slideshare', '1491818684'), ('134', '133', '冒泡广场', 'Bubble', 'Index', '0', '1', '', '1491818817'), ('135', '133', '说说删除', 'Bubble', 'MoodDelete', '1', '0', '', '1491992341'), ('136', '133', '说说点赞删除', 'Bubble', 'MoodPraiseDelete', '2', '0', '', '1491992378'), ('137', '133', '说说评论删除', 'Bubble', 'MoodCommentsDelete', '3', '0', '', '1491992409'), ('138', '102', '主题管理', 'Theme', 'Index', '60', '1', '', '1494381693'), ('139', '102', '主题管理添加/编辑', 'Theme', 'Save', '61', '0', '', '1494398194'), ('140', '102', '主题上传安装', 'Theme', 'Upload', '62', '0', '', '1494405096'), ('141', '102', '主题删除', 'Theme', 'Delete', '63', '0', '', '1494410655'), ('142', '102', '布局导出', 'View', 'LayoutExport', '50', '0', '', '1494490765'), ('143', '102', '布局导入', 'View', 'LayoutImport', '51', '0', '', '1494490833'), ('144', '0', '客户管理', 'Kehu', 'Index', '0', '1', 'am-icon-mortar-board fs-12', '1502465292'), ('145', '144', '预约客户', 'Kehu', 'index', '0', '1', '', '1502465628'), ('146', '144', '潜在客户', 'Kehu', 'qianzai', '0', '1', '', '1502465674'), ('147', '144', '客户到访', 'Kehu', 'daofang', '0', '1', '', '1502465703'), ('148', '0', '数据统计', 'Tongji', 'index', '0', '1', 'am-icon-line-chart fs-12', '1502598735'), ('150', '0', '财务/合同', 'Caiwu', 'index', '3', '1', 'am-icon-folder-open', '1502605542'), ('153', '144', '客户添加/编辑页面', 'Kehu', 'SaveInfo', '0', '0', '', '1504100458'), ('154', '144', '客户添加/编辑', 'Kehu', 'Save', '0', '0', '', '1504100512'), ('156', '144', '客户删除', 'Kehu', 'Delete', '0', '0', '', '1505400761'), ('157', '150', '财务列表', 'Caiwu', 'index', '0', '1', '', '1505404043'), ('158', '150', '财务编辑/添加页面', 'Caiwu', 'SaveInfo', '0', '0', '', '1505404096'), ('159', '150', '财务编辑/添加', 'Caiwu', 'Save', '0', '0', '', '1505404181'), ('160', '150', '财务删除', 'Caiwu', 'Delete', '0', '0', '', '1505404202'), ('161', '0', '学生签到', 'Qiandao', 'Index', '2', '1', 'am-icon-user', '1506005944'), ('162', '161', '签到列表', 'Qiandao', 'Index', '0', '1', '', '1506005990'), ('163', '161', '签到添加/编辑页面', 'Qiandao', 'SaveInfo', '0', '0', '', '1506006076'), ('164', '161', '签到添加/编辑', 'Qiandao', 'Save', '0', '0', '', '1506006112'), ('165', '161', '签到删除', 'Qiandao', 'Delete', '0', '0', '', '1506006145'), ('166', '161', '学生签到', 'Qiandao', 'Qiandao', '0', '0', '', '1506006195');
COMMIT;

-- ----------------------------
--  Table structure for `sc_qiandao`
-- ----------------------------
DROP TABLE IF EXISTS `sc_qiandao`;
CREATE TABLE `sc_qiandao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户id',
  `updatetime` int(11) NOT NULL DEFAULT '0',
  `status` int(11) NOT NULL DEFAULT '0',
  `beizhu` text,
  `pid` int(11) NOT NULL DEFAULT '0' COMMENT '操作者id',
  `xx_id` int(11) NOT NULL DEFAULT '0' COMMENT '学校id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- ----------------------------
--  Records of `sc_qiandao`
-- ----------------------------
BEGIN;
INSERT INTO `sc_qiandao` VALUES ('2', '4', '1504022400', '0', '生病了', '9', '4'), ('4', '4', '1505923200', '0', '', '9', '4'), ('5', '4', '1506014242', '1', null, '9', '4'), ('6', '5', '1506252868', '1', null, '16', '13');
COMMIT;
...
CREATE TABLE `sc_role` (
  ...
  `upd_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='角色组';

-- ----------------------------
--  Records of `sc_role`
-- ----------------------------
BEGIN;
INSERT INTO `sc_role` VALUES ('1', '系统管理员', '1', '1481350313', '2017-01-08 17:06:24'), ('13', '超级管理员', '1', '1484402362', '2017-01-14 21:59:22'), ('14', '学校', '1', '1505051034', '2017-09-10 21:43:54'), ('15', '课程顾问', '1', '1505231413', '2017-09-12 23:50:13'), ('16', '财务/合同', '1', '1505404353', '2017-09-14 23:52:33'), ('17', '老师', '1', '1505914931', '2017-09-20 21:42:11');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1752 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='角色与权限管理';

-- ----------------------------
--  Records of `sc_role_power`
-- ----------------------------
BEGIN;
INSERT INTO `sc_role_power` VALUES ('1263', '13', '41', '1491992489'), ('1264', '13', '42', '1491992489'), ('1265', '13', '1', '1491992489'), ('1266', '13', '22', '1491992489'), ('1267', '13', '4', '1491992489'), ('1268', '13', '28', '1491992489'), ('1269', '13', '29', '1491992489'), ('1270', '13', '32', '1491992489'), ('1271', '13', '33', '1491992489'), ('1272', '13', '34', '1491992489'), ('1273', '13', '63', '1491992489'), ('1274', '13', '131', '1491992489'), ('1275', '13', '30', '1491992489'), ('1276', '13', '31', '1491992489'), ('1277', '13', '35', '1491992489'), ('1278', '13', '37', '1491992489'), ('1279', '13', '36', '1491992489'), ('1280', '13', '64', '1491992489'), ('1281', '13', '132', '1491992489'), ('1282', '13', '38', '1491992489'), ('1283', '13', '39', '1491992489'), ('1284', '13', '57', '1491992489'), ('1285', '13', '58', '1491992489'), ('1286', '13', '59', '1491992489'), ('1287', '13', '65', '1491992489'), ('1288', '13', '40', '1491992489'), ('1289', '13', '60', '1491992489'), ('1290', '13', '61', '1491992489'), ('1291', '13', '62', '1491992489'), ('1292', '13', '66', '1491992489'), ('1293', '13', '67', '1491992489'), ('1294', '13', '74', '1491992489'), ('1295', '13', '75', '1491992489'), ('1296', '13', '76', '1491992489'), ('1297', '13', '77', '1491992489'), ('1298', '13', '78', '1491992489'), ('1299', '13', '79', '1491992489'), ('1300', '13', '80', '1491992489'), ('1301', '13', '81', '1491992489'), ('1302', '13', '103', '1491992489'), ('1303', '13', '105', '1491992489'), ('1304', '13', '104', '1491992489'), ('1305', '13', '107', '1491992489'), ('1306', '13', '123', '1491992489'), ('1307', '13', '124', '1491992489'), ('1308', '13', '125', '1491992489'), ('1309', '13', '106', '1491992489'), ('1310', '13', '108', '1491992489'), ('1311', '13', '102', '1491992489'), ('1312', '13', '82', '1491992489'), ('1313', '13', '84', '1491992489'), ('1314', '13', '85', '1491992489'), ('1315', '13', '86', '1491992489'), ('1316', '13', '87', '1491992489'), ('1317', '13', '83', '1491992489'), ('1318', '13', '88', '1491992489'), ('1319', '13', '89', '1491992489'), ('1320', '13', '90', '1491992489'), ('1321', '13', '91', '1491992489'), ('1322', '13', '92', '1491992489'), ('1323', '13', '93', '1491992489'), ('1324', '13', '94', '1491992489'), ('1325', '13', '95', '1491992489'), ('1326', '13', '96', '1491992489'), ('1327', '13', '97', '1491992489'), ('1328', '13', '98', '1491992489'), ('1329', '13', '99', '1491992489'), ('1330', '13', '100', '1491992489'), ('1331', '13', '101', '1491992489'), ('1332', '13', '109', '1491992489'), ('1333', '13', '126', '1491992489'), ('1334', '13', '127', '1491992489'), ('1335', '13', '128', '1491992489'), ('1336', '13', '129', '1491992489'), ('1337', '13', '130', '1491992489'), ('1338', '13', '133', '1491992489'), ('1339', '13', '134', '1491992489'), ('1340', '13', '135', '1491992489'), ('1341', '13', '136', '1491992489'), ('1342', '13', '137', '1491992489'), ('1343', '13', '8', '1491992489'), ('1344', '13', '12', '1491992489'), ('1345', '13', '43', '1491992489'), ('1346', '13', '50', '1491992489'), ('1347', '13', '10', '1491992489'), ('1348', '13', '44', '1491992489'), ('1349', '13', '51', '1491992489'), ('1350', '13', '11', '1491992489'), ('1351', '13', '45', '1491992489'), ('1352', '13', '52', '1491992489'), ('1353', '13', '24', '1491992489'), ('1354', '13', '46', '1491992489'), ('1355', '13', '53', '1491992489'), ('1356', '13', '25', '1491992489'), ('1357', '13', '47', '1491992489'), ('1358', '13', '54', '1491992489'), ('1359', '13', '26', '1491992489'), ('1360', '13', '48', '1491992489'), ('1361', '13', '55', '1491992489'), ('1362', '13', '27', '1491992489'), ('1363', '13', '49', '1491992489'), ('1364', '13', '56', '1491992489'), ('1365', '13', '68', '1491992489'), ('1366', '13', '69', '1491992489'), ('1367', '13', '70', '1491992489'), ('1368', '13', '71', '1491992489'), ('1369', '13', '72', '1491992489'), ('1370', '13', '73', '1491992489'), ('1371', '13', '118', '1491992489'), ('1372', '13', '119', '1491992489'), ('1373', '13', '120', '1491992489'), ('1374', '13', '121', '1491992489'), ('1375', '13', '122', '1491992489'), ('1543', '14', '144', '1505404287'), ('1544', '14', '145', '1505404287'), ('1545', '14', '146', '1505404287'), ('1546', '14', '147', '1505404287'), ('1547', '14', '153', '1505404287'), ('1548', '14', '154', '1505404287'), ('1549', '14', '148', '1505404287'), ('1550', '14', '149', '1505404287'), ('1551', '14', '150', '1505404287'), ('1552', '14', '157', '1505404287'), ('1553', '14', '158', '1505404287'), ('1554', '14', '159', '1505404287'), ('1555', '14', '160', '1505404287'), ('1556', '14', '155', '1505404287'), ('1557', '14', '1', '1505404287'), ('1558', '14', '22', '1505404287'), ('1559', '14', '19', '1505404287'), ('1560', '14', '20', '1505404287'), ('1561', '14', '21', '1505404287'), ('1562', '14', '28', '1505404287'), ('1563', '14', '29', '1505404287'), ('1564', '14', '32', '1505404287'), ('1565', '14', '33', '1505404287'), ('1566', '14', '34', '1505404287'), ('1567', '14', '63', '1505404287'), ('1568', '14', '131', '1505404287'), ('1569', '14', '30', '1505404287'), ('1570', '14', '31', '1505404287'), ('1571', '14', '35', '1505404287'), ('1572', '14', '37', '1505404287'), ('1573', '14', '36', '1505404287'), ('1574', '14', '64', '1505404287'), ('1575', '14', '132', '1505404287'), ('1576', '14', '8', '1505404287'), ('1577', '14', '12', '1505404287'), ('1578', '14', '43', '1505404287'), ('1579', '14', '50', '1505404287'), ('1580', '14', '10', '1505404287'), ('1581', '14', '44', '1505404287'), ('1582', '14', '51', '1505404287'), ('1583', '14', '11', '1505404287'), ('1584', '14', '45', '1505404287'), ('1585', '14', '52', '1505404287'), ('1586', '14', '24', '1505404287'), ('1587', '14', '46', '1505404287'), ('1588', '14', '53', '1505404287'), ('1589', '14', '25', '1505404287'), ('1590', '14', '47', '1505404287'), ('1591', '14', '54', '1505404287'), ('1592', '14', '26', '1505404287'), ('1593', '14', '48', '1505404287'), ('1594', '14', '55', '1505404287'), ('1595', '14', '27', '1505404287'), ('1596', '14', '49', '1505404287'), ('1597', '14', '56', '1505404287'), ('1598', '14', '68', '1505404287'), ('1599', '14', '69', '1505404287'), ('1600', '14', '70', '1505404287'), ('1601', '14', '71', '1505404287'), ('1602', '14', '72', '1505404287'), ('1603', '14', '73', '1505404287'), ('1687', '16', '144', '1505832625'), ('1688', '16', '145', '1505832625'), ('1689', '16', '146', '1505832625'), ('1690', '16', '147', '1505832625'), ('1691', '16', '153', '1505832625'), ('1692', '16', '154', '1505832625'), ('1693', '16', '156', '1505832625'), ('1694', '16', '150', '1505832625'), ('1695', '16', '157', '1505832625'), ('1696', '16', '158', '1505832625'), ('1697', '16', '159', '1505832625'), ('1698', '16', '160', '1505832625'), ('1699', '16', '28', '1505832625'), ('1700', '16', '29', '1505832625'), ('1701', '16', '32', '1505832625'), ('1702', '16', '33', '1505832625'), ('1703', '16', '34', '1505832625'), ('1704', '16', '63', '1505832625'), ('1705', '16', '131', '1505832625'), ('1706', '15', '144', '1505832640'), ('1707', '15', '145', '1505832640'), ('1708', '15', '146', '1505832640'), ('1709', '15', '147', '1505832640'), ('1710', '15', '153', '1505832640'), ('1711', '15', '154', '1505832640'), ('1712', '15', '156', '1505832640'), ('1713', '15', '150', '1505832640'), ('1714', '15', '157', '1505832640'), ('1715', '15', '158', '1505832640'), ('1716', '15', '159', '1505832640'), ('1717', '15', '160', '1505832640'), ('1718', '15', '28', '1505832640'), ('1719', '15', '29', '1505832640'), ('1720', '15', '32', '1505832640'), ('1721', '15', '33', '1505832640'), ('1722', '15', '34', '1505832640'), ('1723', '15', '63', '1505832640'), ('1724', '15', '131', '1505832640'), ('1725', '15', '30', '1505832640'), ('1726', '15', '31', '1505832640'), ('1727', '15', '35', '1505832640'), ('1728', '15', '37', '1505832640'), ('1729', '15', '36', '1505832640'), ('1730', '15', '64', '1505832640'), ('1731', '15', '132', '1505832640'), ('1739', '17', '161', '1506006248'), ('1740', '17', '162', '1506006248'), ('1741', '17', '163', '1506006248'), ('1742', '17', '164', '1506006248'), ('1743', '17', '165', '1506006248'), ('1744', '17', '166', '1506006248'), ('1745', '17', '28', '1506006248'), ('1746', '17', '29', '1506006248'), ('1747', '17', '32', '1506006248'), ('1748', '17', '33', '1506006248'), ('1749', '17', '34', '1506006248'), ('1750', '17', '63', '1506006248'), ('1751', '17', '131', '1506006248');
COMMIT;
...
-- ----------------------------
--  Records of `sc_school`
-- ----------------------------
BEGIN;
INSERT INTO `sc_school` VALUES ('98', '呜呜呜呜无无', 'admin', '92cecd117ebb71f44f8aeb5c2e2d8a05', '0', '1505049929', '1505049929', '1', '0', '966922', '0'), ('95', 'www', 'aaa', '', '6', '33332', '5666666', '2', '0', '78678', '0'), ('96', 'w', '55555', '05a1716f263fce9d41539305afc52f3c', '0', '1505046569', '0', '1', '0', '675484', '0'), ('97', 'sadasdsaqqqq', 'rwef', 'ed7da03accab0b1975443c6ded4635cb', '0', '1505049495', '1505049541', '1', '0', '960035', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sc_subject` VALUES ('17', '美术', '1', '0', '1482840012', '2016-12-27 20:00:12'), ('19', '舞蹈', '1', '0', '1482851842', '2016-12-27 23:17:22'), ('20', '音乐', '1', '0', '1482851855', '2016-12-27 23:17:35');
COMMIT;
...
-- ----------------------------
--  Table structure for `sc_xuesheng`
-- ----------------------------
DROP TABLE IF EXISTS `sc_xuesheng`;
CREATE TABLE `sc_xuesheng` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(255) NOT NULL DEFAULT '',
  `age` int(11) NOT NULL DEFAULT '0',
  `sex` varchar(255) NOT NULL DEFAULT '',
  ...
  `lxr_2` varchar(255) NOT NULL DEFAULT '',
  `lxrtel_2` varchar(255) NOT NULL DEFAULT '',
  `kecheng` varchar(255) NOT NULL DEFAULT '',
  `sf_time` int(11) NOT NULL DEFAULT '0',
  `sf_content` text,
  `dianmian` varchar(255) NOT NULL DEFAULT '',
  `gw_name` varchar(255) NOT NULL DEFAULT '',
  ...
  `xx_id` int(11) NOT NULL DEFAULT '0' COMMENT '学校id',
  `kc_sc` varchar(255) NOT NULL DEFAULT '',
  `kh_id` int(11) NOT NULL DEFAULT '0' COMMENT '客户id',
  `ls_id` int(11) NOT NULL DEFAULT '0' COMMENT '老师id',
  `updatetime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
--  Records of `sc_xuesheng`
-- ----------------------------
BEGIN;
INSERT INTO `sc_xuesheng` VALUES ('4', '阿萨德', '0', '0', '请问', '15566664444', '', '', '舞蹈', '0', null, '', '', '1506005645', '', '', '0', '8', '5', '2013-05-02', '4', '22', '3', '9', '1506005645'), ('5', 'aa', '0', '0', 'ww', '133222221111', '', '', '音乐', '0', null, '', '', '1506252794', '', '', '0', '15', '14', '2003-05-08', '13', '22', '9', '16', '1506252794');
COMMIT;
